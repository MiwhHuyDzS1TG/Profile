  ...
  const learningItems: LearningItem[] = [
    {
      ...
      description: "Exploring enterprise application development and Android app creation with Java.",
      color: "bg-gradient-to-br from-orange-600 to-red-600",
    },
    {
      name: "C++",
      icon: <Code2 className="h-10 w-10" />,
      description: "Learning systems programming and game development fundamentals with C++.",
      color: "bg-gradient-to-br from-blue-600 to-indigo-600",
    },
    {
      name: "C#",
      icon: <Code2 className="h-10 w-10" />,
      description: "Studying .NET framework and Unity game development with C#.",
