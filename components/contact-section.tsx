...
export default function ContactSection() {
  ...
  const zaloContacts = [
    {
      name: "Tahn",
      phoneNumber: "0357293117",
      restricted: false,
    },
    {
      name: "Tahn Dz",
      phoneNumber: "0379612067",
      restricted: true,
    },
  ]
