...
export default function SkillsSection() {
  const skills: Skill[] = [
    ...
    { name: "PHP", level: 50, color: "from-cyan-600 to-purple-400" },
    { name: "Node.js", level: 65, color: "from-green-600 to-green-400" },
    { name: "Git", level: 75, color: "from-red-600 to-red-400" },
  ]
